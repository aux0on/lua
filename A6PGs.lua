...
local timerDisplay = nil
local onCooldown = false
local fireflyJumpEnabled = false
local clickFireflyJumpEnabled = false
local guiEnabled = false
local timerGuiEnabled = false
local debounce = false
local fjSize = 40
...
FireflyJumpMaid = Maid.new()
RootMaid:GiveTask(FireflyJumpMaid)
...
section:AddToggle("Enable Auto Firefly Jump", function(bool)
    fireflyJumpEnabled = bool
end)
...
RootMaid:GiveTask(function()
    if FireflyJumpGuiMaid then FireflyJumpGuiMaid:DoCleaning() end

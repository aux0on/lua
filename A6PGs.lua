...
local function performFlick()
    ...
    if not murderer or not murderer.Character then
        shared.Notify("Murderer not found!", 2)
        return
    end
    ...
    if distance > maxDistance then
        shared.Notify("Target too far: " .. math.floor(distance) .. " studs", 2)
        return
    end
    ...
    if direction.Magnitude > 0 then
        ...
        if smoothReturn and flickSpeed > 0 then
...
flick_section:AddDropdown("Keyboard Key", keyboardKeys, function(selected)
    ...
    shared.Notify("Key set to: " .. selected, 2)
end)

flick_section:AddDropdown("Mouse Button", mouseButtons, function(selected)
    selectedInput = selected
    shared.Notify("Mouse button: " .. selected, 2)
end)
...
flick_section:AddLabel("IMPORTANT:")
flick_section:AddLabel("• ShiftLock is temporarily disabled during flick")

shared.Notify("Flick-to-Murderer v4.2 Loaded!", 3)
shared.Notify("Enable 'Auto-Disable ShiftLock' for it to work!", 4)
print("=====================================")
print("Flick-to-Murderer Plugin v4.2")
print("Optimized flick sequence")
print("=====================================")

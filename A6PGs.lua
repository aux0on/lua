...
do
    ...
    local animOptions = {
        ...
        "Princess", "Cowboy", "Patrol", "Zombie FE", "Catwalk Glam", "Amazon Unboxed","Glow Motion","Bubbly","Adidas Comm"
    }
...
local positionPresets = {
    ...
    ["Bottom Right"] = UDim2.new(0.80, 0, 0.96, 0),
    ["Bottom Left"]  = UDim2.new(0.02, 0, 0.96, 0),
}
